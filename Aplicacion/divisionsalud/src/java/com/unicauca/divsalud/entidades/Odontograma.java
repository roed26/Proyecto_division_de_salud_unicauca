...
@NamedQueries({
    ...
    @NamedQuery(name = "Odontograma.findByActualizacion", query = "SELECT o FROM Odontograma o WHERE o.idActualizacion = :actualizacionOdo")
})
public class Odontograma implements Serializable {
    ...
    @Size(max = 100)
    @Column(name = "IMG_FUERA_BOL_PER")
    private String imgFueraBolPer;
    ...
    public void setImgFueraNEnd(String imgFueraNEdn) {
        this.imgFueraNEnd = imgFueraNEdn;
    }

    public String getImgFueraBolPer() {
        return imgFueraBolPer;
    }

    public void setImgFueraBolPer(String imgFueraBolPer) {
        this.imgFueraBolPer = imgFueraBolPer;
    }
    ...
    public String toString() {
        return "com.unicauca.divsalud.entidades.Odontograma[ id=" + id + " ]";
    }
