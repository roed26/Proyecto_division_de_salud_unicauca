...
public class ActualizacionOdo implements Serializable {
    ...
    @OneToMany(mappedBy = "idActualizacion")
    private Collection<AntOdo> antOdoCollection;
    ...
    @XmlTransient
    public Collection<AntOdo> getAntOdoCollection() {
        return antOdoCollection;
    }

    public void setAntOdoCollection(Collection<AntOdo> antOdoCollection) {
        this.antOdoCollection = antOdoCollection;
    }
