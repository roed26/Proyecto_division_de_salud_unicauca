...
@NamedQueries({
    ...
    ,
    @NamedQuery(name = "Higiene.findByHiguiene", query = "SELECT h FROM Higiene h WHERE h.higiene = :higuiene")
    ,
...
public class Higiene implements Serializable {
    ...
    public void setHigiene(String higuiene) {
        this.higiene = higuiene;
    }
    ...
    public String toString() {
        return "com.unicauca.divsalud.entidades.Higiene[ id=" + id + " ]";
    }
