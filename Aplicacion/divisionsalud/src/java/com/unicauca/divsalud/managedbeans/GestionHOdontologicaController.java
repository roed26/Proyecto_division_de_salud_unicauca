...
public class GestionHOdontologicaController implements Serializable {
    ...
    public void seleccionarPaciente(Paciente paciente) {
        ...
        for (int i = 0; i < listaActualizaciones.size(); i++) {
            ...
            if (i == 0) {
                ...
                Collection<AntOdo> collectionAntecendetesOdo = new ArrayList<>(ejbAntOdo.buscarPorActualizacion(actualizacionActual));
                ...
                actualizacionActual.setAntOdoCollection(collectionAntecendetesOdo);
    ...
    public void seleccionarPaciente(Paciente paciente, CargarVistaController cargarVista) {
        ...
        requestContext.update("listaHistoriaOdontologica");
        requestContext.execute("PF('seleccionPacienteDialog').hide()");
        cargarVista.cargarGestionHistoriaOdontologica();
