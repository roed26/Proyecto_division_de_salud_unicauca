...
import com.unicauca.divsalud.sessionbeans.ServiciosOdoFacade;
...
public class ServiciosOdoController implements Serializable {
    ...
    @EJB
    private com.unicauca.divsalud.sessionbeans.ServiciosOdoFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/BundleServicios").getString("ServiciosOdoCreated"));
    ...
    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/BundleServicios").getString("ServiciosOdoDeleted"));
        if (!JsfUtil.isValidationFailed()) {
